        ...
        <div className="shadow-lg position-sticky top-0 z-50 dark:bg-gray-800 ">
            <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between h-16">
                ...
                <div className="flex gap-4">
                    <button className="bg-gradient-to-r from-gray-200 to-white rounded-full px-3 font-bold cursor-pointer hover:scale-105 transition-all duration-300 w-[80px]">Login</button>
                    <button className="bg-gradient-to-r from-gray-200 to-white rounded-full px-3 py-2 font-bold cursor-pointer hover:scale-105 transition-all duration-300">Get Started</button>
